...
_long_description = "See https://github.com/priv-kweihmann/multimetricishvel for documentation"
...
setuptools.setup(
    ...
    url="https://github.com/priv-kweihmann/multimetricishvel",
    packages=setuptools.find_packages(),
    install_requires=requirements,
        entry_points={
        "console_scripts": [
            "multimetricishvel = multimetricishvel.__main__:main",
        ]
    },
    classifiers=[
